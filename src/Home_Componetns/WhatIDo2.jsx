...
const WhatIDo2 = () => {
    return (
        <div className='flex flex-col  p-5  text-white'>
            <h1 className='text-3xl md:text-5xl font-bold text-center mb-5'>Full Stack Java Development</h1>
            ...
            <div className='grid grid-cols-5 md:grid-cols-5 lg:grid-cols-6 gap-5 mt-10'>
                {[
                    ...
                    <div key={label} className='relative flex flex-col items-center transition-transform transform hover:scale-110 group'>
                        <span className='absolute bottom-full opacity-0 transition-opacity duration-300 group-hover:opacity-100 text-sm text-white'>
                            {label}
                        </span>
            ...
            <section className='mt-5'>
                ...
                <ul className='list-none pl-5 space-y-2 font-[anzo2]'>
                    <li>⚡ Building responsive website front ends using React-Redux</li>
                    <li>⚡ Developing mobile applications using Flutter, React Native, and Kotlin</li>
                    <li>⚡ Creating application backends in Node, Express & Flask</li>
                </ul>
            </section>
        </div>
    );
